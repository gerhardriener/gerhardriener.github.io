...
- *Loss Aversion in Social Image Concerns* with Hannah Schildberg-Hörisch and Vasilisa Petrishcheva, accepted with minor revisions *Experimental Economics*

- *Reacting to ambiguous messages: An experimental analysis* with Christian Kellner (Southampton) and Mark LeQuement (East Anglia), R&R (second round) *Games and Economic Behavior*

- *Until the debt will tear us apart: the rise of affective polarisation"* with Roula Nezi (Surrey), Ann-Kathrin Reinl (Munich), and Alexia Katsanidou (Cologne), under review *Political Behavior*
